		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					String strMinPrice = (String)request.getParameter("minPrice");
					String strMaxPrice = (String)request.getParameter("maxPrice");
					...
					if (strZipcode != "" && strMinPrice != "" && strMaxPrice != ""){
						rs = con.getRs("SELECT * FROM rent WHERE zipcode='"+strZipcode+"' AND price >=" + MinPrice + " AND price <=" + MaxPrice);
					}else if (strZipcode != "" && strMinPrice != ""){
						rs = con.getRs("SELECT * FROM rent WHERE zipcode='"+strZipcode+"' AND price >=" + MinPrice);
					}else if (strZipcode != "" && strMaxPrice != ""){
						rs = con.getRs("SELECT * FROM rent WHERE zipcode='"+strZipcode+"' AND price <=" + MaxPrice);
					}else if (strMinPrice != "" && strMaxPrice != ""){
						rs = con.getRs("SELECT * FROM rent WHERE price >=" + MinPrice + " AND price <=" + MaxPrice);
					}else if (strZipcode != ""){
						rs = con.getRs("SELECT * FROM rent WHERE zipcode='"+ strZipcode +"'");
					}else if (strMinPrice != ""){
						rs = con.getRs("SELECT * FROM rent WHERE price >=" + MinPrice);
					}else if (strMaxPrice != ""){
						rs = con.getRs("SELECT * FROM rent WHERE price <=" + MaxPrice);
					}
